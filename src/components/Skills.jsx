...
const Skills = ({
  ...
  containerSelector = ".skills-container", // <-- container selector prop (update to your section selector)
}) => {
  ...
  useEffect(() => {
    ...
    // Select container (section) to restrict cursor effect
    ...
    // Show custom cursor & hide default cursor on container mouse enter
    ...
    // Hide custom cursor & restore default cursor on container mouse leave
    const handleContainerMouseLeave = () => {
      document.body.style.cursor = originalCursor;
      if (cursorRef.current) {
        gsap.to(cursorRef.current, { autoAlpha: 0, duration: 0.3 });
      }
    };
    ...
    // Move cursor on mousemove **only inside container**
    const moveHandler = (e) => {
      // Check if event is inside container
    ...
    // Target mouseover handler (inside container)
    const enterHandler = (e) => {
      ...
      // Also check container itself if matches targetSelector
      if (container.matches(targetSelector)) {
